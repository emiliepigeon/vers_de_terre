 ...
 */
final class Version20240902071346 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD image_id INT NOT NULL, DROP image_name, DROP image_featured');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD image_name VARCHAR(255) DEFAULT NULL, ADD image_featured VARCHAR(255) DEFAULT NULL, DROP image_id');
    }
}
